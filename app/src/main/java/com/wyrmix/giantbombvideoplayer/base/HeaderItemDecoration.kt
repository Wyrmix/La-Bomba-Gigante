...
class HeaderItemDecoration(@ColorInt background: Int, private val sidePaddingPixels: Int, @param:LayoutRes private val headerViewType: Int) : RecyclerView.ItemDecoration() {
    ...
    private fun isHeader(child: View, parent: RecyclerView): Boolean {
        ...
        val viewType = layoutManager.getItemViewType(child)
